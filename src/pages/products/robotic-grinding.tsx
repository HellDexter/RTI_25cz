...
export default function RoboticGrinding() {
  return (
    <>
      <Head>
        <title>Robotické broušení | Robotech</title>
        <meta name="description" content="Automatizované brousicí systémy pro dokonalou povrchovou úpravu. Přesné a efektivní řešení pro průmyslové broušení a leštění materiálů." />
      </Head>
          ...
          <div className="relative container mx-auto px-4 py-16 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
              ...
              >
                ...
                >
                  <div className="text-gray-700">
                    ...
                    <p className="mb-4">
                      Systém je vybaven pokročilými senzory, které v reálném čase monitorují proces broušení a námi vyvinutý post-processing automaticky upravuje parametry dráhy robota podle aktuálního stavu povrchu a požadovaného výsledku.
                    </p>
                  </div>
                </motion.div>
              ...
              <motion.div
                ...
                className="mb-24"
              >
                <h2 className="text-3xl font-bold mb-4 hover:text-[#0aef0b] transition-colors duration-300 text-center">
                  Klíčové vlastnosti
                </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                  {[
                    ...
                    <motion.div
                      ...
                      className="bg-white p-8 rounded-xl border-2 border-[#0aef0b] hover:bg-[#0aef0b]/5 transition-colors duration-300 group"
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  {[
                    ...
                    <motion.div
                      ...
                      viewport={{ once: true }}
                      transition={{ duration: 0.5, delay: index * 0.1 }}
                      className="bg-white rounded-xl p-10 border-2 border-[#0aef0b] hover:bg-[#0aef0b]/5 transition-colors duration-300 group"
                    >
                      <h3 className="text-2xl font-bold mb-6 group-hover:text-[#0aef0b] transition-colors duration-300">{area.title}</h3>
