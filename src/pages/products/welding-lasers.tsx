              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                  {[
                    ...
                    >
                      <h3 className="text-xl font-bold mb-4 group-hover:text-[#0aef0b] transition-colors duration-300">
                        {feature.title}
                      </h3>
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  {[
                    ...
                    >
                      <h3 className="text-2xl font-bold mb-6 group-hover:text-[#0aef0b] transition-colors duration-300">
                        {area.title}
                      </h3>
