  ...
  return (
    <>
      <Head>
        ...
        <meta 
          name="description" 
          content="Ekologické a efektivní řešení pro čištění povrchů pomocí laserové technologie" 
        />
      </Head>
            ...
            <div className="mb-32">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                {features.map((feature, index) => (
                  <motion.div
                    key={feature.title}
                    className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 group hover:border-[#0aef0b] hover:border-2"
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {applications.map((application, index) => (
                  <motion.div
                    ...
                    transition={{ duration: 0.5, delay: index * 0.1 }}
                  >
                    <h3 className="text-2xl font-bold mb-6 group-hover:text-[#0aef0b] transition-colors duration-300">{application.title}</h3>
